...
const EdgeTierRoiSimple: React.FC = () => {
  ...
  // Step 5 – Business & revenue (with skip)
  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-6 rounded-3xl bg-slate-50 p-6 shadow-sm lg:p-8">
      <header className="flex flex-col gap-2">
        ...
        <p className="max-w-3xl text-sm text-slate-600">
          ...
          industries. We’ll turn your answers into an ROI view for
          EdgeTier’s AI agent assistance and QA automation.
        </p>
      ...
      <div className="grid gap-6 lg:grid-cols-[1.8fr,1.2fr]">
        {/* Wizard side */}
        <div className="flex flex-col gap-4">
                  ...
                  {costMode === "known" ? (
                    <div className="max-w-xs">
                      <label className="flex flex-col gap-1 text-sm">
                        ...
                        <span className="text-xs text-slate-500">
                          Salary + benefits + overhead. A rough
                          estimate is fine.
                        </span>
                      </label>
                    </div>
                    ...
                    <div>
                      <p className="mb-2 text-xs text-slate-600">
                        Pick where most of your agents are based and
                        we’ll use typical fully-loaded cost
                        benchmarks.
                      </p>
              ...
              <div className="space-y-5">
                  ...
                  <div className="grid gap-2 md:grid-cols-2">
                    {(
                      [
                        ...
                        "40-60",
                        "60+",
                      ] as ContactVolumeBand[]
                    ).map((band) => (
                      <button
                        key={band}
                        type="button"
                        onClick={() =>
                          setContactVolumeBand(band)
                        }
                        className={`rounded-xl border px-3 py-2 text-left text-xs ${
                ...
                <div className="border-t border-slate-100 pt-4">
                  ...
                  <p className="mb-3 text-xs text-slate-600">
                    Slide to the closest match. This is where sectors
                    like e-commerce, travel and gaming typically sit.
                  </p>
          ...
          {currentStep === 3 && (
            <section className="rounded-2xl bg-white p-4 shadow-sm lg:p-5">
              ...
              <p className="mb-4 text-xs text-slate-600">
                This calibrates what EdgeTier can realistically add on
                top of your current tooling.
              </p>
              ...
              <div className="grid gap-3 md:grid-cols-3">
                ...
                >
                  ...
                  <p className="text-[11px]">
                    Mostly manual work. Macros/templates, little or no
                    AI in agent workflows. QA is sampled manually.
                  </p>
                ...
                >
                  ...
                  <p className="text-[11px]">
                    Some AI in routing, bots or tagging. QA partly
                    automated or sampled. Insights are available but
                    not always actioned.
                  </p>
                  <p className="mt-2 text-[10px] text-slate-500">
                ...
                >
                  ...
                  <p className="text-[11px]">
                    AI already supports core workflows – agent assist,
                    QA scoring, categorisation. Looking for the next
                    layer of impact.
                  </p>
                  <p className="mt-2 text-[10px] text-slate-500">
          ...
          {currentStep === 4 && (
            <section className="rounded-2xl bg-white p-4 shadow-sm lg:p-5">
              ...
              <p className="mb-4 text-xs text-slate-600">
                We’ll focus the ROI model on the outcomes you care
                about most.
              </p>
              ...
              <div className="grid gap-3 md:grid-cols-2">
                ...
                >
                  ...
                  <p className="text-[11px]">
                    Shorter calls/chats so customers wait less and
                    agents handle more with the same headcount.
                  </p>
                </button>
                ...
                >
                  ...
                  <p className="text-[11px]">
                    Automate QA across every interaction and give team
                    leads time back for coaching.
                  </p>
                </button>
                ...
                >
                  ...
                  <p className="text-[11px]">
                    Spot issues earlier and cut avoidable &quot;where
                    is my order?&quot; and &quot;why was I
                    charged?&quot; contacts.
                  </p>
                </button>
                ...
                >
                  ...
                  <p className="text-[11px]">
                    Lift customer experience and protect revenue by
                    fixing issues before they snowball.
                  </p>
                </button>
              </div>
            </section>
          ...
          {currentStep === 5 && (
            <section className="rounded-2xl bg-white p-4 shadow-sm lg:p-5">
              ...
              <p className="mb-4 text-xs text-slate-600">
                Optional. Skip this if you just want to see
                operational savings.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-2 rounded-xl bg-slate-50 p-3 text-xs">
                  ...
                  />
                  <label
                    htmlFor="skip-revenue"
                    className="text-slate-700"
                  >
                    Don&apos;t include revenue impact – just show
                    operational savings.
                  </label>
                </div>
              </div>
            ...
            <section className="rounded-2xl bg-white p-4 shadow-sm lg:p-5">
              ...
              <div className="space-y-4">
                ...
                <div className="border-t border-slate-100 pt-4">
                  ...
                  {investmentMode === "auto" && (
                    <p className="mt-1 text-[11px] text-slate-500">
                      We&apos;ll estimate licence cost from team size
                      and rollout scope. This is not an official
                      quote, just a planning number.
                    </p>
                  )}
                </div>
              </div>
          ...
          <div className="mt-1 flex items-center justify-between">
            ...
            >
              {currentStep < 5 && "Next"}
              {currentStep === 5 && "Review investment"}
              {currentStep === 6 && "See results"}
            </button>
          </div>
        </div>
            ...
            {showResults ? (
              <>
                ...
                <p className="mt-1 text-xs text-slate-300">
                  Combined cost savings and revenue protected for this
                  team and rollout.
                </p>
              ...
              <div className="mt-4 text-sm text-slate-300">
                Work through the 6 steps on the left. Once you&apos;ve
                set team size, volume, AI usage and rollout scope,
                we&apos;ll show an ROI view calibrated to your
                inputs.
              </div>
            )}
          </div>
          ...
          <div className="rounded-2xl bg-white p-5 text-sm text-slate-800 shadow-sm">
            ...
            {showResults ? (
              <>
                ...
                <ul className="space-y-1 text-xs text-slate-700">
                  ...
                  <li>
                    ...
                    <span className="font-semibold">
                      {formatCurrency(
                        results.costPerContactBaseline
                      )}
                    </span>
                  </li>
                  <li>
                    ...
                    <span className="font-semibold">
                      {formatNumber(
                        results.contactsAvoidedPerYear
                      )}
                    </span>
                  </li>
                </ul>
              ...
              <p className="text-xs text-slate-600">
                Once you&apos;ve answered the questions, we&apos;ll
                show how the value splits across handling time, QA,
                reduced contacts and (optionally) revenue protection.
              </p>
            )}
          </div>
        </aside>
